...
import { signUp, getUsers, login, logout, me, createAdmin, deleteUser, updateUser } from "../controllers/authController";
...
router.put('/users/:id', checkAuth, checkAdmin, requirePermission('manageUsers'), asyncMiddleware(updateUser));
